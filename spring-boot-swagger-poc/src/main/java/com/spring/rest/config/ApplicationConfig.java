...
public class ApplicationConfig {
	...
	public Docket productApi() {
		return new Docket(DocumentationType.SWAGGER_2)
		.select()
		.apis(RequestHandlerSelectors.basePackage("com.spring.rest.controllers"))
		.build()
		.apiInfo(getApiInfo());
	}
	
	public ApiInfo getApiInfo() {
		 Contact contact = new Contact("DEV", "http://blog.Perficient.com", "devsupport@perficient.com");
	        return new ApiInfoBuilder()
	                .title("Employee Rest API")
	                .description("Employee REST Endpoints")
	                .version("1.0.0")
	                .license("Apache 2.0")
	                .licenseUrl("http://www.apache.org/licenses/LICENSE-2.0")
	                .contact(contact)
